...
export default function Guestbook() {
    ...
    const addMessage = async function(message) {
        try {
            const response = await axios.post('/api/guestbook', message);
    ...
    const fetchMessages = async function() {
        try {
            ...
            const response = await axios.get(`/api/guestbook?id=${startId}`);
            const jsonResult = response.data;
            ...
            <Modal
                ...
                <div>
                    <form
                        ...
                        onSubmit={async (e) => {
                            try {
                                const response = await fetch(`/api/guestbook/${e.target.id.value}`, {
                                    method: 'delete',
                                    headers: {
